...
fun MtyCardWithImageAndTexts(modifier: Modifier = Modifier) {
    Column(
        ...
        Text(
            text = "Giovanni Junseo Kim",
            fontSize = 28.sp,
            fontWeight = FontWeight.Bold,
            color = colorResource(id = R.color.green_android_3ddc84),
            modifier = modifier.padding(14.dp)
        )
        Text(text = "Android Potato Developer", fontSize = 22.sp, color = Color.White)
        Spacer(modifier = modifier.fillMaxHeight(0.1f))
        Divider()
        Row(
            ...
            Text(text = "010-1234-5678", color = Color.White)
        }
        Divider()
        Row(
            modifier = modifier.fillMaxWidth(0.7f),
            ...
            Text(text = "share to your friends", color = Color.White)
        }
        Divider()
        Row(
            modifier = modifier.fillMaxWidth(0.7f),
            ...
            Text(text = "junseojjang@google.com", color = Color.White)
        }
    }
}
